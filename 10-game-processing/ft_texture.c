...
int		ft_texture_add(char *line, char *txt)
{
	...
	&& g_infos.no_texture == NULL && ++a)
		g_infos.no_texture = txt;
	else if (line[0] == 'S' && line[1] == 'O'
			&& g_infos.so_texture == NULL && ++a)
		g_infos.so_texture = txt;
	else if (line[0] == 'S' && ft_is_whitespace(line[1])
			&& g_infos.s_texture == NULL && ++a)
		g_infos.s_texture = txt;
	else if (line[0] == 'E' && line[1] == 'A'
			&& g_infos.ea_texture == NULL && ++a)
		g_infos.ea_texture = txt;
	else if (line[0] == 'W' && line[1] == 'E'
	&& g_infos.we_texture == NULL && ++a)
		g_infos.we_texture = txt;
	if (a)
		return (0);
